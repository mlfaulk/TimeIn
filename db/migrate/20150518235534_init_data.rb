class InitData < ActiveRecord::Migration
  def up
    ...
    #Load resources
    r1 = Resource.new(:char_scen_img_file => "scen1.jpg", :good_char => 1, :caption => "Peeta gives bread to Katniss.")
    r1.save(:validate => false)
    r2 = Resource.new(:char_scen_img_file => "scen2.jpg", :good_char => 1, :caption => "Suzy and Brian comfort Tim when he's crying.")
    r2.save(:validate => false)
    r3 = Resource.new(:char_scen_img_file => "scen3.jpg", :good_char => 1, :caption => "Cam coaches Manny in football.")
    r3.save(:validate => false)
    r4 = Resource.new(:char_scen_img_file => "scen4.jpg", :good_char => 0, :caption => "Francis stuffs Timmy in a locker.")
    r4.save(:validate => false)
    r6 = Resource.new(:char_scen_img_file => "scen6.jpg", :good_char => 0, :caption => "Spongebob and Patrick steal a balloon.")
    r6.save(:validate => false)
    r9 = Resource.new(:char_scen_img_file => "charscenes/scen9.jpg", :good_char => 0, :caption => "Pinocchio tells a lie.")
    r9.save(:validate => false)
    r10 = Resource.new(:char_scen_img_file => "charscenes/scen10.jpg", :good_char => 0, :caption => "Lilly copies an answer off of Maria’s test.")
    r10.save(:validate => false)
    r11 = Resource.new(:char_scen_img_file => "charscenes/scen11.jpg", :good_char => 0, :caption => "Joseph and Calvin get in a fight.")
    r11.save(:validate => false)
    r12 = Resource.new(:char_scen_img_file => "charscenes/scen12.jpg", :good_char => 1, :caption => "Kate, Rob, Vanessa, and Stew dance in the school talent show.")
    r12.save(:validate => false)
    r13 = Resource.new(:char_scen_img_file => "charscenes/scen13.jpg", :good_char => 1, :caption => "Olivia paints a card for her mom.")
    r13.save(:validate => false)
    r14 = Resource.new(:char_scen_img_file => "charscenes/scen14.jpg", :good_char => 1, :caption => "Ben teaches Michelle to play drums.")
    r14.save(:validate => false)
    r15 = Resource.new(:char_scen_img_file => "charscenes/scen15.jpg", :good_char => 1, :caption => "Anthony speaks clearly when he says the morning announcements.")
    r15.save(:validate => false)
    r16 = Resource.new(:char_scen_img_file => "charscenes/scen16.jpg", :good_char => 1, :caption => "Simone gives Jessica a hug.")
    r16.save(:validate => false)
    r17 = Resource.new(:char_scen_img_file => "charscenes/scen17.jpg", :good_char => 0, :caption => "Alex throws trash on the ground.")
    r17.save(:validate => false)
    r18 = Resource.new(:char_scen_img_file => "charscenes/scen18.jpg", :good_char => 1, :caption => "Beyonce collects food for charity.")
    r18.save(:validate => false)
    r19 = Resource.new(:char_scen_img_file => "charscenes/scen19.jpg", :good_char => 1, :caption => "Stephanie gives her bus seat to an old man.")
    r19.save(:validate => false)
    r20 = Resource.new(:char_scen_img_file => "charscenes/scen20.JPG", :good_char => 1, :caption => "Carlos helps Vivian with her homework when she is struggling.")
    r20.save(:validate => false)
    r21 = Resource.new(:char_scen_img_file => "charscenes/scen21.jpg", :good_char => 1, :caption => "Juan helps Jim solve a problem.")
    r21.save(:validate => false)
    r22 = Resource.new(:char_scen_img_file => "charscenes/scen22.jpg", :good_char => 1, :caption => "Carl buys ice cream for Russel.")
    r22.save(:validate => false)
    r23 = Resource.new(:char_scen_img_file => "charscenes/scen23.jpg", :good_char => 1, :caption => "Taylor Swift taught herself to play the guitar by practicing everyday.")
    r23.save(:validate => false)
    #r24 = Resource.new(:char_scen_img_file => "charscenes/scen24.html", :good_char => 1, :caption => "Thomas keeps working on a puzzle, even though it is very hard.")
    #r24.save(:validate => false)
    r25 = Resource.new(:char_scen_img_file => "charscenes/scen25.jpg", :good_char => 1, :caption => "Zoe and Mariah play fairly during a game of CandyLand.")
    r25.save(:validate => false)
    r26 = Resource.new(:char_scen_img_file => "charscenes/scen26.jpg", :good_char => 1, :caption => "Matt finishes a long book.")
    r26.save(:validate => false)
    r27 = Resource.new(:char_scen_img_file => "charscenes/scen27.jpg", :good_char => 1, :caption => "Mark and Louis high-five after a game of soccer.")
    r27.save(:validate => false)
    r28 = Resource.new(:char_scen_img_file => "charscenes/scen28.jpg", :good_char => 0, :caption => "Margo gives up on learning Chinese when it gets hard.")
    r28.save(:validate => false)
    r29 = Resource.new(:char_scen_img_file => "charscenes/scen29.jpg", :good_char => 0, :caption => "James make fun of Snape and call him names.")
    r29.save(:validate => false)
    r30 = Resource.new(:char_scen_img_file => "charscenes/scen30.jpg", :good_char => 0, :caption => "Students spread rumors about someone else.")
    r30.save(:validate => false)
    r31 = Resource.new(:char_scen_img_file => "charscenes/scen31.jpg", :good_char => 0, :caption => "McKayla acts annoyed when she does not win first place.")
